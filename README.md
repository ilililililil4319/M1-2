...
**🛠 Render 대시보드(개발자 계정, 로그인 필요):** https://dashboard.render.com/web/srv-dah1i7bl550s73d6ajg0
**🛠 Vercel 대시보드(개발자 계정, 로그인 필요):** https://vercel.com/1-ac35/m1-2
...
8. [전체 작업 순서 (STEP 1~19)](#8-전체-작업-순서-step-119)
9. [작업 흐름도](#9-작업-흐름도)
...
18. [자체 점검 체크리스트](#18-자체-점검-체크리스트)
19. [결론 및 한계점](#19-결론-및-한계점)
...
2. **2021년 부채비율 급락(106.1% → 35.65%) — 재무구조 악화가 아니라 연결범위 변경**
   ...
   - **해석(Why):** 이 시점은 라인(LINE)-야후재팬(Z홀딩스) 경영통합과 정확히 일치한다. 라인이 연결범위에서 제외(지분법 적용 전환)되며 부채 총액 자체가 줄어든 회계적 요인이다. (실제 뉴스 검색으로 검증)
